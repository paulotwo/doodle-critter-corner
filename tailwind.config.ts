    ...
    extend: {
      ...
      colors: {
        ...
        paint: {
          ...
          brown: "hsl(var(--paint-brown))",
          black: "hsl(var(--paint-black))",
        },
        sidebar: {
      ...
      keyframes: {
        ...
        "pop-in": { "0%": { transform: "scale(0.6)", opacity: "0" }, "60%": { transform: "scale(1.1)", opacity: "1" }, "100%": { transform: "scale(1)" } },
        "wiggle": { "0%,100%": { transform: "rotate(-3deg)" }, "50%": { transform: "rotate(3deg)" } },
        "float-soft": { "0%,100%": { transform: "translateY(0)" }, "50%": { transform: "translateY(-8px)" } },
        "bounce-in": { "0%": { transform: "scale(0)" }, "70%": { transform: "scale(1.15)" }, "100%": { transform: "scale(1)" } },
      },
      animation: {
